...
window.CONTENT = {
  ...
  topics: {
    psychology: [
      ...
      { t: '亲密关系中的“追逃模式”如何破局', dir: '解释依恋类型，给出三句改变互动循环的表达模板', aud: '恋爱与婚姻中的年轻人', form: '短视频 · 对话演示' },
      ...
      { t: '为什么表扬孩子聪明会害了他', dir: '成长型思维研究，给出三句正确表扬模板', aud: '家长与教育者', form: '短视频 · 家庭场景' },
    ...
    parenting: [
      { t: '孩子写作业磨蹭，先别催——三步找到真原因', dir: '区分能力问题、动机问题与环境问题，各给对策', aud: '小学生家长', form: '短视频 60 秒' },
      { t: '不吼不叫的沟通模板：三句话让孩子配合', dir: '描述事实 + 表达感受 + 给出选择，附真实对话', aud: '3-10 岁家长', form: '短视频 · 情景演示' },
      { t: '幼小衔接到底要准备什么', dir: '不是提前学拼音，而是四种能力：专注、自理、表达、规则', aud: '学前家长', form: '图文清单' },
      { t: '如何培养孩子的时间观念', dir: '沙漏法、任务清单法、番茄钟儿童版三个工具', aud: '6-12 岁家长', form: '图文 + 视频演示' },
      { t: '孩子说“我不想上学”，家长第一句该说什么', dir: '先处理情绪再处理事情，给出提问顺序', aud: '中小学家长', form: '短视频 45 秒' },
      { t: '手机管理不靠没收：家庭屏幕使用公约模板', dir: '共同制定规则的四个步骤，附可打印公约', aud: '青春期家长', form: '图文 + 模板' },
      { t: '为什么二胎家庭要避免“你是哥哥要让着”', dir: '公平感缺失的长期影响，给出替代表达', aud: '二胎家庭', form: '短视频 60 秒' },
      { t: '亲子共读的正确打开方式：从读完到读懂', dir: '提问三层次法：事实 → 感受 → 联想', aud: '3-8 岁家长', form: '图文干货' },
      { t: '孩子考砸了，如何做一次有效复盘', dir: '不谈分数谈过程，用三栏表格拆解失分原因', aud: '中小学家长', form: '图文 + 表格模板' },
      { t: '专注力训练的日常小游戏（无需教具）', dir: '舒尔特方格、听指令游戏、找不同，各配时长建议', aud: '学龄前与低年级家长', form: '短视频合集' },
      { t: '如何回答孩子关于金钱的问题', dir: '按年龄段给出财商教育路线：零花钱、储蓄罐、记账', aud: '5-14 岁家长', form: '深度图文' },
      { t: '青春期沉默的孩子，如何重新建立对话', dir: '并肩沟通法：散步、开车、共同做事时更容易开口', aud: '青春期家长', form: '短视频 60 秒' },
      { t: '别再问“今天在学校怎么样”，换这五个问题', dir: '开放式提问模板，提高孩子表达意愿', aud: '全龄段家长', form: '短视频 · 高转发' },
      { t: '规则感如何建立：温和而坚定的四个要点', dir: '事前约定、事中执行、事后复盘、始终一致', aud: '2-8 岁家长', form: '图文干货' },
      { t: '孩子说谎背后的四种心理需求', dir: '逃避惩罚、寻求关注、维护自尊、想象混淆', aud: '学龄家长', form: '深度图文' },
      { t: '如何让孩子主动收拾房间', dir: '环境设计法：降低收纳难度 + 可视化标签 + 固定时间', aud: '低龄家长', form: '短视频 · 家居演示' },
      { t: '兴趣班怎么选：三个不后悔的判断标准', dir: '孩子意愿、家庭时间成本、能力迁移性', aud: '幼小家长', form: '图文清单' },
      { t: '家长情绪管理：发火之后如何修复关系', dir: '道歉四步法：承认、解释、承诺、修复行动', aud: '全龄段家长', form: '短视频 45 秒' },
      { t: '阅读理解差，可能是这三种能力没打通', dir: '识字量、背景知识、推断能力，各给训练方法', aud: '小学家长', form: '深度图文' },
      { t: '如何培养孩子的抗挫力', dir: '允许失败、复盘归因、小步成功体验三条路径', aud: '全龄段家长', form: '短视频 60 秒' },
      { t: '暑期计划表怎么排才不流于形式', dir: '固定锚点 + 弹性时段 + 每周复盘，附模板', aud: '中小学家长', form: '图文 + 模板' },
      { t: '孩子被同学孤立，家长该怎么做', dir: '倾听、事实核查、能力建设、必要时介入的顺序', aud: '中小学家长', form: '深度图文' },
      { t: '早教到底教什么：0-3 岁的真实重点', dir: '安全感、语言输入、感统发展，避免超前学习焦虑', aud: '新手父母', form: '短视频 60 秒' },
      { t: '如何和老师有效沟通（家长必备话术）', dir: '开场、提问、请求支持三段式模板', aud: '全龄段家长', form: '图文清单' }
    ],
    career: [
