    ...
    if (it.type === 'link') {
      ...
      if (bv) {
        return '<div class="item beauty-card">' +
          ...
          '<div class="bili-wrap"><iframe class="bili-player" src="https://player.bilibili.com/player.html?bvid=' + bv + '&page=1&high_quality=1&danmaku=0" allowfullscreen="true" scrolling="no" border="0" frameborder="no" framespacing="0" allow="autoplay; fullscreen"></iframe></div>' +
